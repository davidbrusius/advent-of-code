defmodule Day02Test do
  ...
  test "part 1 - returns the sum of valid game's ids" do
    input =
      """
    ...
    assert Day02.play_part1(input) == 8
  end

  test "part 1 - returns the sum of valid game's ids for puzzle input" do
    assert Day02.play_part1(@puzzle_input) == 2551
  end

  test "part 2 - returns the sum of all game's power" do
    input =
      """
      Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
      Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
    ...
    assert Day02.play_part2(input) == 2286
  end

  test "part 2 - returns the sum of all game's power for puzzle input" do
    assert Day02.play_part2(@puzzle_input) == 62811
  end
end
