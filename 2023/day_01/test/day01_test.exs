defmodule Day01Test do
  ...
  test "part 1 - returns the calibration value from a input" do
    input =
      """
      1abc2
      pqr3stu8vwx
    ...
    assert Day01.calibration(input) == 142
  end

  test "part 2 - returns the calibration value from a input" do
    input =
      """
      two1nine
      eightwothree
  ...
  test "custom input" do
    ...
    assert Day01.calibration(input) == 53539
  end
end
